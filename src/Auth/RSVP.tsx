...
import confirmed from "../Assets/775118.jpg"
import logoblack from "../Assets/CodeLabBestLogo.png"
...
const [user, setuser] = useState<Array<iData>>()


useEffect(()=>{
setuser(JSON.parse(localStorage.getItem("invite")!))
},[user])

let arr:iData = localStorage[localStorage.length - 1]
